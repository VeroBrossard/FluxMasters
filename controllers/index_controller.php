...
foreach ($rss->channel->item as $item) {
  ...
  if ($countTotalItems <= $nbrCard) {
    ...
    // //exemple <description>
    // <![CDATA[ L’homme d’affaires finance le concours d’innovation X Prize Carbon Removal. L’idée est de trouver des solutions pour supprimer le dioxyde de carbone déjà présent dans l’air et les océans. <br/><br/> <img src="https://img.bfmtv.com/c/150/100/466/e79a2c49457c1f52fa25e03d3ea74.jpg"/> ]]>
