...
$codesource = getXml('https://www.google.fr/search?q=web+scraping');
//$codesource = file_get_contents('https://www.google.fr/search?q=web+scraping');
//echo $codesource;
//#<div class=\"kCrYT\"><a href=\"/url\?q=(.+)\"><h3 class=\".+\">(.+)</div></h3>.+</a></div>#

//(On met des # autour du code, on échappe les “doubles quote” avec un \ <br>
...
preg_match_all("#<div class=\"kCrYT\"><a href=\"/url\?q=(.+)\"><h3 class=\".+\">(.+)</div></h3>.+</a></div>#iU", $codesource, $tableau_resultat);
...
echo'<br> ci-dessous, $tableau_resultat[1][1] <br>';
print_r($tableau_resultat[1][1]);
